...
class Aes extends  Com\Crypt\Aes\AbstractAes
{
     ...
     */
    public static function encode($plaintext, $password, $nBits = 256)
    {
     ...
     */
    public static function decode($ciphertext, $password, $nBits = 256)
    {
        $blockSize = 16; // block size fixed at 16 bytes / 128 bits (Nb=4) for AES
        if (! ($nBits == 128 || $nBits == 192 || $nBits == 256))
            return ''; // standard allows 128/192/256 bit keys
