...
namespace Com\Zend\TimeSync;

use Com;

class Ntp extends Com\Zend\TimeSync\Protocol
{
    /**
     ...
     *
     * @return array
     * @throws Com\Zend\TimeSync\Exception When timeserver can not be connected
     */
    protected function _read()
    {
        ...
        if ($info['timed_out'] === true) {
            fclose($this->_socket);
            throw new Com\Zend\TimeSync\Exception('could not connect to ' .
    ...
    protected function _write($data)
    {
        ...
        stream_set_timeout($this->_socket, Com\Zend\TimeSync::$options['timeout']);
    }
