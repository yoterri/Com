...
abstract class Protocol
{
    ...
    protected function _connect()
    {
        $socket = @fsockopen($this->_timeserver, $this->_port, $errno, $errstr,
                             Com\Zend\TimeSync::$options['timeout']);
        if ($socket === false) {
            throw new \Zend\TimeSync\Exception('could not connect to ' .
     ...
     *
     * @param  string|Com\Zend\Locale $locale (Optional) Locale
    ...
    public function getDate($locale = null)
    {
        ...
        $date = new Com\Zend\Date($this, null, $locale);
        return $date;
    }
}
