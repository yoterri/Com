...
class Math
{
    ...
    public static $add   = array('Com\Zend\Locale\Math', 'Add');
    public static $sub   = array('Com\Zend\Locale\Math', 'Sub');
    public static $pow   = array('Com\Zend\Locale\Math', 'Pow');
    public static $mul   = array('Com\Zend\Locale\Math', 'Mul');
    public static $div   = array('Com\Zend\Locale\Math', 'Div');
    public static $comp  = array('Com\Zend\Locale\Math', 'Comp');
    public static $sqrt  = array('Com\Zend\Locale\Math', 'Sqrt');
    public static $mod   = array('Com\Zend\Locale\Math', 'Mod');
     ...
     *   round(0.36665, 4);
     * then try:
     *   Com\Zend\Locale\Math::round('639.795', 2);
     */
    public static function round($op1, $precision = 0)
    {
        ...
        if ($triggerDigit >= '5') {
            ...
            if ($op1 > 0) {
                if (self::$_bcmathDisabled) {
                    return Com\Zend\Locale\Math\PhpMath::Add($op1, $roundUp, $precision);
                }
                return self::Add($op1, $roundUp, $precision);
            } else {
                if (self::$_bcmathDisabled) {
                    return Com\Zend\Locale\Math\PhpMath::Sub($op1, $roundUp, $precision);
                }
...
if (!extension_loaded('bcmath')
    ...
    Com\Zend\Locale\Math\PhpMath::disable();
}
