...
class Security
{
     ...
     *
     * @param  string $xml
     * @throws Com\Zend\Xml\Exception If entity expansion or external entity declaration was discovered.
     */
    protected static function heuristicScan($xml)
    {
        foreach (self::getEntityComparison($xml) as $compare) {
            if (strpos($xml, $compare) !== false) {
                throw new Com\Zend\Xml\Exception(self::ENTITY_DETECT);
            }
        }
    }
    ...
    public static function scan($xml, \DOMDocument $dom = null)
    {
        ...
        set_error_handler(array('Com\Zend\Xml\Security', 'loadXmlErrorHandler'), E_WARNING);
    ...
    public static function scanFile($file, DOMDocument $dom = null)
    {
        if (!file_exists($file)) {
            ...
            throw new Com\Zend\Xml\Exception(
